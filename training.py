...
# Transpose data so its orientated correctly
...
# Select a random subset of images and labels from x_train and y_train
indices = np.random.randint(0, x_train.shape[0], total_images)

# Grabs first 25 images
...
fig, axes = plt.subplots(rows, columns, figsize=(12, 8), squeeze=False)
